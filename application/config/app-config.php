...
*
*/
define('APP_BASE_URL', 'https://newerp.grupomegaload.com/');
...
*/
define('APP_ENC_KEY', 'd5bb672248768ba087f575df24fc79ea');
 ...
 */
define('APP_DB_USERNAME', 'megaload_erproot');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '2022*Megaload');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'megaload_erp_ddbb_lts');
