...
<div class="tab-content">
   ...
   <div role="tabpanel" class="tab-pane" id="invoice">
       ...
       <!--Aqui voy a crear los tab para controlar los registros de cada tipo de factura.-->
       <div style="border: 1px solid #0e1827; border-radius: 15px;margin-top: 10px;padding: 15px;">
           <div class="horizontal-scrollable-tabs mbot15">
               <div class="horizontal-tabs">
                   <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                       <li role="presentation" class="active">
                           <a href="#consumidor-final" aria-controls="consumidor-final" role="tab" data-toggle="tab">Consumidor Final</a>
                       </li>
                       <li role="presentation">
                           <a href="#credito-fiscal" aria-controls="credito-fiscal" role="tab" data-toggle="tab">Credito Fiscal</a>
                       </li>
                       <li role="presentation">
                           <a href="#fact-exportacion" aria-controls="fact-exportacion" role="tab" data-toggle="tab">Factura de Exportacion</a>
                       </li>
                   </ul>
               </div>
           </div>
           <div class="tab-content">
               <div role="tabpanel" class="tab-pane active" id="consumidor-final">
                   <div class="form-group">
                       <label class="control-label" for="resolution-name-cf">Resolución</label>
                       <input type="text" id="resolution-name-cf" name="settings_invoice[1][resolution-name]" class="form-control" value="<?= $_ci_vars[0]['resolution_name']; ?>">
                   </div>
                   <div class="form-group">
                       <label class="control-label" for="prefix-cf">Formato de prefijo para factura</label>
                       <input type="text" id="prefix-cf" name="settings_invoice[1][prefix]" class="form-control" value="<?= $_ci_vars[0]['prefix']; ?>">
                   </div>
                   <div class="form-group">
                       ...
                       <label class="control-label" for="next-number-cf">Siguiente número de factura</label>
                       <input type="number" min="1" id="next-number-cf" name="settings_invoice[1][next-number]" class="form-control" value="<?= $_ci_vars[0]['next_number']; ?>">
                   </div>
                   <div class="form-group">
                       <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="Cantidad de facturas a generar"></i>
                       <label class="control-label" for="qty-limit-cf">Cantidad de facturas</label>
                       <input type="number" min="1" id="qty-limit-cf" name="settings_invoice[1][qty-limit]" class="form-control" value="<?= $_ci_vars[0]['qty_limit']; ?>">
                   </div>
               </div>
               <div role="tabpanel" class="tab-pane" id="credito-fiscal">
                   <div class="form-group">
                       <label class="control-label" for="resolution-name-ccf">Resolución</label>
                       <input type="text" id="resolution-name-ccf" name="settings_invoice[2][resolution-name]" class="form-control" value="<?= $_ci_vars[1]['resolution_name']; ?>">
                   </div>
                   <div class="form-group">
                       <label class="control-label" for="prefix-ccf">Formato de prefijo para factura</label>
                       <input type="text" id="prefix-ccf" name="settings_invoice[2][prefix]" class="form-control" value="<?= $_ci_vars[1]['prefix']; ?>">
                   </div>
                   <div class="form-group">
                       <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="<?php echo _l('settings_sales_next_invoice_number_tooltip'); ?>"></i>
                       <label class="control-label" for="next-number-ccf">Siguiente número de factura</label>
                       <input type="number" min="1" id="next-number-ccf" name="settings_invoice[2][next-number]" class="form-control" value="<?= $_ci_vars[1]['next_number']; ?>">
                   </div>
                   <div class="form-group">
                       <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="Cantidad de facturas a generar"></i>
                       <label class="control-label" for="qty-limit-ccf">Cantidad de facturas</label>
                       <input type="number" min="1" id="qty-limit-ccf" name="settings_invoice[2][qty-limit]" class="form-control" value="<?= $_ci_vars[1]['qty_limit']; ?>">
                   </div>
               </div>
               <div role="tabpanel" class="tab-pane" id="fact-exportacion">
                   <div class="form-group">
                       <label class="control-label" for="resolution-name-fe">Resolución</label>
                       <input type="text" id="resolution-name-fe" name="settings_invoice[3][resolution-name]" class="form-control" value="<?= $_ci_vars[2]['resolution_name']; ?>">
                   </div>
                   <div class="form-group">
                       <label class="control-label" for="prefix-fe">Formato de prefijo para factura</label>
                       <input type="text" id="prefix-fe" name="settings_invoice[3][prefix]" class="form-control" value="<?= $_ci_vars[2]['prefix']; ?>">
                   </div>
                   <div class="form-group">
                       <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="<?php echo _l('settings_sales_next_invoice_number_tooltip'); ?>"></i>
                       <label class="control-label" for="next-number-fe">Siguiente número de factura</label>
                       <input type="number" min="1" id="next-number-fe" name="settings_invoice[3][next-number]" class="form-control" value="<?= $_ci_vars[2]['next_number']; ?>">
                   </div>
                   <div class="form-group">
                       <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="Cantidad de facturas a generar"></i>
                       <label class="control-label" for="qty-limit-fe">Cantidad de facturas</label>
                       <input type="number" min="1" id="qty-limit-fe" name="settings_invoice[3][qty-limit]" class="form-control" value="<?= $_ci_vars[2]['qty_limit']; ?>">
                   </div>
               </div>
           </div>
       </div>
      ...
      <div class="form-group">
         ...
         <div class="radio radio-primary radio-inline">
          ...
          <div class="radio radio-primary radio-inline">
              <input type="radio" name="settings[invoice_number_format]" value="5" id="prefix_number_based" <?php if(get_option('invoice_number_format') == '5'){echo 'checked';} ?>>
              <label for="prefix_number_based">prefix-000001</label>
          </div>
         <hr />
      </div>
