...
class Estimates_model extends App_Model
{
     ...
     */
    public function convert_to_invoice($id, $client = false, $draft_invoice = false, $invoice_type ="normal")
    {
        ...
        if($invoice_type == "credito"){
            ...
            $this->invoices_model = $this->creditos_model;
        }else{
